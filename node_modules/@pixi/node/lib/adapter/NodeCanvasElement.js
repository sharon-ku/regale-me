...
const { Canvas, CanvasRenderingContext2D, Image } = canvasModule__default["default"];
...
class NodeCanvasElement extends canvasModule__default["default"].Canvas {
  ...
  getContext(type, options) {
    switch (type) {
      ...
      case "experimental-webgl": {
        ...
        this._ctx = super.getContext("2d", options);
        const ctx = createGLContext__default["default"](width, height, options);
